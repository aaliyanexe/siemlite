    ...
    <PageWrapper>
      <div style={{ padding: '0 20px 40px' }}>
        ...
        <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border-subtle)', borderRadius: 8, overflow: 'hidden' }}>
          ...
          {/* Header */}
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 80px 100px 120px 100px', padding: '0 20px', height: 40, alignItems: 'center', borderBottom: '1px solid var(--border-subtle)', background: 'var(--bg-elevated)' }}>
          ...
          {loading ? (
            ...
            filtered.map((u, i) => {
              ...
              return (
                <div key={u.user_id}>
                  <div style={{
                    display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 80px 100px 120px 100px',
